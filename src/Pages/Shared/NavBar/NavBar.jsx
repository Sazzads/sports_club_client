            ...
            <div className="navbar bg-base-300  max-w-screen-xl">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 z-[1000]">
                            {navbarOptions}
                        </ul>
                    </div>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 z-[1000]">
                        {navbarOptions}
                    </ul>
                </div>
